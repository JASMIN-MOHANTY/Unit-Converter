...
//     if(InputTypeValue === "meter" && ResultTypeValue ==="kilo-meter"){
//         Result.value = Number(Input.value)* 0.001;
//     }else if(InputTypeValue === "meter" && ResultTypeValue ==="centi-meter"){
//         Result.value = Number(Input.value)* 100;
//     }else if(InputTypeValue === "meter" && ResultTypeValue ==="meter"){
//         Result.value = Number(Input.value)* 1;
//     }

//     if(InputTypeValue === "kilo-meter" && ResultTypeValue ==="meter"){
//         Result.value = Number(Input.value)* 1000;
//     }else if(InputTypeValue === "kilo-meter" && ResultTypeValue ==="centi-meter"){
//         Result.value = Number(Input.value)* 100000;
//     }else if(InputTypeValue === "kilo-meter" && ResultTypeValue ==="kilo-meter"){
//         Result.value = Number(Input.value)* 1;
//     }

//     if(InputTypeValue === "centi-meter" && ResultTypeValue ==="kilo-meter"){
//         Result.value = Number(Input.value)* 0.00001;
//     }else if(InputTypeValue === "centi-meter" && ResultTypeValue ==="meter"){
//         Result.value = Number(Input.value)* 0.01;
//     }else if(InputTypeValue === "centi-meter" && ResultTypeValue ==="centi-meter"){
//         Result.value = Number(Input.value)* 1;
//     }
// }
